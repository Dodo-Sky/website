...
export async function renderUsersTable(usersData) {
  ...
  addUserBtn.classList.add('btn', 'btn-primary', 'mt-3')
  ...
  const roles = ['управляющий', 'менеджер смены', 'менеджер офиса', 'администратор', 'Гость']
  const units = ['Тюмень-1', 'Тюмень-2', 'Тюмень-3', 'Тюмень-4', 'Тюмень-5', 'Тюмень-6', 'Тюмень-7', 'Тюмень-8', 'Офис']
